...
const GuidewireCaseStudy = () => {
  return (
    <div className="min-h-screen px-6 py-24 max-w-5xl mx-auto space-y-16">
      ...
      <Section title="Our Approach">
        We designed a weekly-based parametric income insurance system where workers 
        contribute like a savings model but receive automated coverage against disruptions.

        Instead of reactive insurance, we introduce a proactive, AI-driven system 
        that predicts disruptions and protects income before losses occur.
      ...
      {/* TECH STACK */}
      <Section title="Tech Stack (Planned)">
        <ul className="list-disc pl-5 space-y-2">
          <li>Frontend: React + Tailwind CSS</li>
          <li>Backend: Node.js / FastAPI</li>
          <li>AI Models: Risk Prediction using Weather + Traffic APIs</li>
          <li>Data Sources: OpenWeather API, Maps API</li>
          <li>Core Engine: Parametric Trigger-Based Insurance Logic</li>
        </ul>
      </Section>
      ...
      <Section title="Future Scope">
        <ul className="list-disc pl-5 space-y-2">
          <li>Advanced fraud detection using behavioral patterns</li>
          <li>Integration with real delivery platforms (Zomato, Swiggy APIs)</li>
          <li>Personalized risk scoring for each worker</li>
          <li>Expansion to other gig sectors beyond delivery</li>
        </ul>
      </Section>
