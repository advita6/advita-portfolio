  ...
  const projects = [
    {
      ...
      description:
        'Built MRI upload + voice-command functionality, improving accuracy by 30%. Deployed on AWS EC2 with secured routing.',
    ...
    },
    {
      ...
      description:
        'Developed a system for cloud scalability insights, smart alerts, and automated safety actions, focusing on cost-efficiency and API-driven logic.',
    ...
    },
    {
      title: 'AutoML Agent',
      description:
        'Created a user interface and API communications, leading to a 25% improvement in accuracy. Deployed on AWS for scalable execution.',
    ...
    },
    {
      ...
      description:
        'Developed a system for mine safety alerts using real-time IoT and ML modules.',
    ...
    },
    {
      ...
      description:
        'Implemented deployments for frontend, backend, and database. Utilized ConfigMaps, ClusterIP, NodePort, and tested scaling & self-healing capabilities.',
  ...
  const achievements = [
    {
      ...
      description:
        "Elected Vice President of GLA University's Cloud Club. Led cloud workshops, events, training, and managed collaborations.",
      year: '2025',
      icon: Users,
    },
    {
      ...
      description:
        'Runner-up for Rockfall Guardian project - a mine safety alert system using real-time IoT and ML.',
      year: '2025',
      icon: Award,
    },
  ];
